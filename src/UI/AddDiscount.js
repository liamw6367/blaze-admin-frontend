...
const AddDiscount = (props) => {
    ...
    const [selectedDiscountingProducts, setSelectedDiscountingProducts] = useState([]);
    ...
    const [allProductsAreMarked, setAllProductsAreMarked] = useState(false);
    ...
    const discountDataFormIsValid = nameInputIsValid && codeNameInputIsValid && rewardTypeFieldIsValid && ((currentType === "Percentage(%)") ? rewardPercentageInputIsValid : (currentType === "Product(Multiple)") ? rewardProductsFieldIsValid : true) && criteriaFieldIsValid && ((currentCriterion === "Min Bill") ? minBillInputIsValid : (currentCriterion === "Welcome Back") ? durationInputIsValid : true) && (!allProductsAreMarked ? discountingProductsFieldIsValid : true);

    const discountDataHandler = (event) => {
        event.preventDefault();
        const discountData = {
            discountName: enteredName,
            discountCodeName: enteredCodeName,
            ...
            main={
                <div className={`blaze-main ${justCtx.isExtended ? "" : "wide"}`}>
                    <div className="store-info-box info-box-margin" onClick={(event) => hideCategoryNamesDropdownHandler(event)}>
                        <form action="#" name="" id="" onSubmit={discountDataHandler}>
                            ...
                            <div className="user-inputs">
                                <div className="user-inputs__container">
                                    ...
                                    <div>
                                        <input 
                                            className={`user-inputs__input ${ codeNameInputIsInvalid ? "invalid" : codeNameInputIsValid ? "valid" : "" }`}
                                            type="text" 
                                            name="" 
                                            id="code-name" 
                                            value={enteredCodeName} 
                                            onChange={changeCodeNameInputValueHandler}
                                            onBlur={blurCodeNameInputHandler}                                    
                                        />
                                        {
                                            codeNameInputIsInvalid && <p className="error-message">This field is required!</p>
                                        }
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="user-inputs">
                                <div className="user-inputs__container reward-type-div">
                                    ...
                                    <div>
                                        <CriteriaDropdown className="user-inputs__input" onTrigger={triggerCriterionHandler} />
                                    </div>
                                </div>
                            </div>
                            {
